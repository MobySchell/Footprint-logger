          ...
          <div className="bg-white rounded-xl p-8 shadow-[5px_5px_0px_1px_rgba(0,0,0,15)] outline-1">
            {leaderboard.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          <div className="text-center mb-2">
                            ...
                            >
                              {leaderboardUser.userName || "Anonymous"}
                              {isCurrentUser && (
                            ...
                            <div className="text-sm text-gray-600">
                              {leaderboardUser.activityCount} activities
                            </div>
                          </div>
                          <div
                          ...
                          >
                            ...
                            >
                              {leaderboardUser.totalEmissions} kg CO₂
                            </div>
                            {position === 1 && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-blue-600">
                        {leaderboard.reduce(
                          (sum, user) => sum + user.activityCount,
                          0
                        )}
                      </div>
                      <div className="text-sm text-gray-600">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-purple-600">
                        {leaderboard
                          .reduce((sum, user) => sum + user.totalEmissions, 0)
                          .toFixed(1)}
                      </div>
                      <div className="text-sm text-gray-600">
                        Total CO₂ Tracked (kg)
              ...
              <div className="text-center text-gray-500 py-16">
                ...
                <p className="text-xl mb-2">No leaderboard data yet</p>
